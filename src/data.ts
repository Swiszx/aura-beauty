...
export const services: ServiceFamily[] = [
  ...
  },
  {
    ...
    italicDE: 'Lifting.',
    italicEN: 'lifting.',
    taglineDE: 'Form, Farbe, Richtung — die Brauen, die dein Gesicht rahmen.',
...
export const philosophy = [
  ...
  },
  {
    ...
    titleDE: 'Vier Wochen später, wir sehen uns wieder.', titleEN: 'Four weeks later, we meet again.',
